def f_exp(Array, Diameter_internal, Density, PressureGradient, MassFlux, f_name = 'f_exp [-]' ):
    ...
    Inputs are: Array - final table, Diameter_internal - internal diameter, Density - density of the fluid, PressureGradient - in the flow duct, MassFlux - of the relative flow.'''

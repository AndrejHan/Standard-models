def Souza_Pimenta_1995(Array, MassQual, rho_l, rho_g, DynVisc_l, DynVisc_g, TPM_name = 'phi^2_pred_Souza_Pimenta_1995_lo [-]'):
    ...
    Inputs are: Array - final table, MassQual - mass quality [-], rho_l - density of the liquid [kg/m^3], rho_g - density of the gas [kg/m^3], DynVisc_l - Dynamic viscosity of liquid [Pa*s], DynVisc_g - Dynamic viscosity of gas [Pa*s].'''

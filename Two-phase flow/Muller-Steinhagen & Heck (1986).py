def MullerSteinhagen_Heck_1986(Array, Chisholm_Y, MassQual, TPM_name = 'phi^2_pred_MullerSteinhagen_Heck_1986_lo [-]'):
    '''Calculation of Muller-Steinhagen and Heck (1986) model for two phase flow multiplier - liquid only.
    Inputs are: Array - final table, Chisholm_Y - Y two-phase parameter defined by Chisholm [-], MassQual - mass quality [-].'''    
